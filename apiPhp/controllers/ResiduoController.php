...
class ResiduoController {
    ...
    public function patch($id) {
        ...
        if ($this->residuo->actualizarParcial($id, $data)) {
            http_response_code(200);
            echo json_encode(["message" => "Residuo actualizado correctamente"]);
        } else {
            http_response_code(500);
            echo json_encode(["message" => "Error al actualizar el residuo"]);
        }
    }
